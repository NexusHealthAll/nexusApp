  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      if (selectedRole === "health-worker") {
        ...
        console.log("Creating hospital admin auth:", {
          tempAuthToken,
          tempUserData,
        });
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F3FAFF] via-[#F8FBFF] to-[#EDF7FF] dark:from-neutral-950 dark:via-neutral-950 dark:to-neutral-900 flex flex-col">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-8">
        <div className="w-full max-w-4xl mx-auto">
          ...
          <div
            className={`grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 max-w-4xl mx-auto transition-all duration-700 delay-400 ease-out ${
              showCards
                ? "translate-y-0 opacity-100"
