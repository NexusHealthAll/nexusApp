    ...
    <div className="flex h-full flex-col rounded-2xl border border-neutral-100 bg-white p-5 dark:border-neutral-800 dark:bg-neutral-900">
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="flex items-center gap-1 text-sm font-semibold text-neutral-600 transition-colors hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-50"
        >
          View all shifts
              ...
              return (
                <li key={shift.id}>
                  <Link
                    ...
                    className="flex items-center gap-3 rounded-xl px-1 py-3 transition-colors hover:bg-neutral-50 dark:hover:bg-neutral-800"
                  >
                    <AvatarInitials
